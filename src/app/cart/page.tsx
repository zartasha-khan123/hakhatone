...
//     const imageUrl = searchParam.get("imageUrl");
...
//       if (!isDuplicate) {
//         updatedCart.push({ name, price, description, image, quantity: 1, imageUrl });
//       }
      ...
      <div className="container mx-auto px-4 py-8 mt-[99px]">
        ...
        <div className="mb-8 bg-gray-50 p-4 rounded-lg">
          <div className="flex items-center gap-2">
            <p className="text-sm font-medium">Free Delivery</p>
            <p className="text-sm text-gray-600">
              Applies to orders of $ 14,00 or more.
            </p>
            <Link href={"/shippingengine"}>
              <Button variant="link" className="text-sm">
                View details
